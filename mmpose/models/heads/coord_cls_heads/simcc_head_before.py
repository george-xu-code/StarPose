...
from mmpose.evaluation import simcc_pck_accuracy_before
...
class SimCCHeadBefore(BaseHead):
    ...
    def forward(self, feats: Tuple[Tensor]) -> Tuple[Tensor, Tensor]:
        ...
        # B, N, C = x.shape
        # print("before xpredict:")
        # print(x.size())
        pred_x = self.mlp_head_x(x)
        # pred_x = pred_x.reshape(B, N, self.W).contiguous()
        # print("after xpredict:")
        # print(pred_x.size())
        # print("before ypredict:")
        # print(x.size())
        pred_y = self.mlp_head_y(x)
        # pred_y = pred_y.reshape(B, N, self.H).contiguous()
        # print("after ypredict:")
        # print(pred_y.size())
    ...
    def loss(
        ...
        # calculate accuracy
        _, avg_acc, _ = simcc_pck_accuracy_before(
